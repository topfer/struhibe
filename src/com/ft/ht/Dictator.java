 ...
 *     
 */
public class Dictator  implements java.io.Serializable {
    ...
    public Dictator(String firstName, String lastName) {
        this.firstName = firstName;
        this.lastName = lastName;
    }
    public Dictator(String firstName, String lastName, Date birthDate, Date added, Date inPower, short offsprings) {
       this.firstName = firstName;
       this.lastName = lastName;
